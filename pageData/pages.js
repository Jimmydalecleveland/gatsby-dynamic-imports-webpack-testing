module.exports = [
  ...
  },
  {
    ...
    components: [
      ...
      { id: 99, name: "Billboard" },
      { id: 99, name: "Breadcrumbs" },
      { id: 99, name: "CTABar" },
      { id: 99, name: "List" },
      { id: 99, name: "LinkButton" },
      { id: 99, name: "PackageCard" },
      { id: 99, name: "Pullquote" },
      { id: 99, name: "SplitContent" },
      { id: 99, name: "VariableContent" },
      { id: 99, name: "Footer" },
    ],
  },
  {
